...
/**P 7.2 answers: 
 * menu/draw and drawing the old picture can be executed simoutaneously
 * P 7.3 answers: 
 * when the picture is drawing, can not execute menu. can not click "menu" button. 
*/
